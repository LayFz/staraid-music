...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils
{
    ...
    public static final String dateDayNow()
    {
        return dateTimeNow(YYYYMMDD);
    }

    public static final String dateYearNow()
    {
        return dateTimeNow(YYYY);
    }

    public static final String dateHourNow(){return dateTimeNow(YYYY_MM_DD_HH);}
    ...
    public static String getLastDay(int lastDay){
        ...
        Date d = c.getTime();
        return DateFormatUtils.format(d, YYYY_MM_DD);
    }
    /**
     * 获取当前时间前一小时的时间
     */
    public static String beforeOneHourToNowDate() {
        ...
        return DateFormatUtils.format(calendar.getTime(), YYYY_MM_DD_HH);
    }
